...
# ╔═╡ 1d573bb0-b563-11ee-1a04-fd8aba1d3154
using RxInfer, Distributions, LinearAlgebra, Random, Plots, BenchmarkTools, Parameters

# ╔═╡ 0c08bcc1-6567-4c9f-bb72-c484a44fe497
module Parallel
	include("../parallel.jl")
end

# ╔═╡ f7781649-ed31-4ecb-92a1-a81a08748954
Threads.nthreads()

# ╔═╡ 1180a1bb-150e-429b-8bfc-f2ca333457e5
begin
...
# ╔═╡ b0ccfb42-d895-45b8-a233-c45caf2bb897
...
# ╔═╡ 32066c18-73a1-4f92-a90c-6a9bf880f0d5
begin
...
# ╔═╡ d10623f6-e547-4c14-b86c-1d9c0ae16e91
begin
	morder  = 25
...
# ╔═╡ e3b0c8c5-d811-4bc8-8673-3e9c0864254c
function run_test(prod_strategy, pipeline)
	return infer(
	    model = lar_model(martype, length(observations), morder, mc, real_τ, prod_strategy, pipeline), 
	    data  = mdata,
...
# ╔═╡ 2c1df362-c924-4e15-bc22-3bb2ad074dd2
@benchmark run_test(nothing, nothing)

# ╔═╡ 3d5bfb62-1272-4d86-a1e6-33cfc2cf1719
...
manifest_format = "2.0"
project_hash = "13553e3caf00db0dab852fa042ac65cc06d9f7ad"
