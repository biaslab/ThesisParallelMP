...
using RxInfer, Random, StatsPlots, BenchmarkTools
...
# ╔═╡ 9b3e4976-d0cf-40b3-9efc-bf4aec9c518f
...
# ╔═╡ 806ca717-eeea-4a14-ad7d-70456fe35226
...
# ╔═╡ be494e1c-5ceb-4ba3-9200-9755beb67ae7
...
# ╔═╡ 6f06c70a-b4f1-409d-acf4-f8ea18b37d0c
...
# ╔═╡ 7b363c3b-771c-434f-9e0c-b59dc3e4f486
function after_iteration_cb(model, iteration)
	return nothing
end

# ╔═╡ d70d6f45-dde3-4012-8193-d2c048bbd121
...
# ╔═╡ ff446546-a006-4d79-9514-fe32e287fc36
...
# ╔═╡ 013727c7-75a4-4eca-a831-3ad0e63fd86a
parallel = false

# ╔═╡ 8e71acce-ff41-42a2-87d7-41f59b3d5d88
begin
	parallel_prod_strategy = CustomProdStrategy(custom_prod)
	parallel_pipeline = ThreadsPipelineStage()
end
...
function run_test(prod_strategy, pipeline)
	return inference(
	    ...
	    data  = (y = dataset, ),
		callbacks = (after_iteration = after_iteration_cb, ),
	)
end
...
begin
	plot(prior, label = "Prior", fill = 0, fillalpha = 0.2)
	plot!(result.posteriors[:θ], label = "Posterior", fill = 0, fillalpha = 0.2)
end
...
@benchmark run_test(CustomProdStrategy(custom_prod), ThreadsPipelineStage())
...
manifest_format = "2.0"
project_hash = "9e54929132cc50168e57084370a076010a74da81"
...
git-tree-sha1 = "0734b5d2294f3452ff963458ca17adde20ac5caa"
...
git-tree-sha1 = "a449a39aa207ae63dab0d5f5843163bf998d81d7"
